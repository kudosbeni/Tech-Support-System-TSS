...
$("body").append('<div class="fixed-button active"><a href="homeTechinicien.php" class="btn btn-md btn-primary"><i class="ti-home" aria-hidden="true"></i> Dashboard</a> </div>');var $window=$(window),nav=$(".fixed-button");
