...
elseif(strlen($TechniciPhone)<10) {
   ...
   $conn->query("INSERT INTO `technicientb`(techniciennames,technicienphone,technicienemail,technicieaddress,techniciepass,technicienspecial,techniciendescrip,technicienphoto,technicienstatus,technicienrequest,addedon) VALUES('$TechniciNames','$TechniciPhone','$TechniciEmail','$TechnicieFullAddress','$TechniciPass','$TechniciSpecialIn','$TechniciDescr','$PIk','DesActive','Pending','$t')") or die(mysqli_error());
