                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span id="more-details"><?php echo $_SESSION["managernames"]; ?><i class="fa fa-caret-down"></i></span>
                                    </div>
                                </div>
                          ...
                          <!--   <div class="pcoded-navigation-label">Navigation</div> -->
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="homeManager.php" class="waves-effect waves-dark">
                    ...
                    <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="homeManager.php">Dashboard </a>
                                            </li>
                        ...
                        <div class="pcoded-inner-content">
                         ...
                         $conn=mysqli_connect("localhost","root","", "techiciensupportdb") or die(mysql_error());
                          $sno=0;
                         $query = $conn->query("SELECT * FROM `technicientb` WHERE technicienstatus = 'DesActive' AND technicienrequest='Pending' ORDER BY  technicienid DESC") or die(mysqli_error());
                         ...
                         ?>
                                                        ...
                                                        <tbody>
                                                            <tr class="table-active">
                                                                ...
                                                                <td><?php echo $sno; ?></td>
                                                                 <td><?php echo $fetch['techniciennames']?></td>
                                                                  <td><?php echo $fetch['technicienphone']?></td>
                                                                   <td><?php echo $fetch['technicienemail']?></td>
                                                                  
                                                                     <td><?php echo $fetch['technicienspecial']?></td>
                                                                     
                                                                       <td><?php echo $fetch['technicienstatus']?></td>
                                                                        <td><?php echo $fetch['technicienrequest']?></td>
                                                                <td><img src="../assets/images/avatar-4.jpg" alt="user image" class="img-radius img-50 align-top m-r-15"></td>
                                                                <td><?php echo $fetch['addedon']?></td>
                                                                <td>
                                                                    
                                                                

                         <a title="Edit Account " href="updatePendingProfileAccounts.php?id=<?php echo $fetch['technicienid']?>"  class="">  <span class="fa fa-edit fw-fa"></span></a>

                     <a title="Delete Account" onclick="return confirm('are you sure you want to delete')" href="deletePendingProfileAccount.php?id=<?php echo $fetch['technicienid']?>"  class="  ">  <span class="fa fa-trash fw-fa"></span></a>
