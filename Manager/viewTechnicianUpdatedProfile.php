            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                      ...
                      <label for="password2" class="d-block"><!-- Status --></label>
                         <button type="submit" name="showdata" class="btn btn-primary "  style="margin-top: 20px;">
                      Show
                    </button> 
                    </div>
                  </div>
              ...
              $query = "SELECT * FROM technicientb WHERE technicienstatus = '$Sstatus' AND technicienrequest='$RequestStatus' ORDER BY  technicienid DESC";
