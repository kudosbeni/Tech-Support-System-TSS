                        ...
                        <option>Cancelled</option>
                            ...
                            <!--  -->
                                <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <button type="submit" class="btn btn-primary">Filter</button> <button type="button" class="btn btn-primary"  onclick="window.print();" id="print-btn" style="margin-left:100px; margin-top: -65px;">Print</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                          ...
                          <?php 
                                ...
                                if(isset($_GET['from_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM technicientb WHERE technicienstatus = '$Sstatus' AND technicienrequest='$RequestStatus' AND addedon='$from_date' ORDER BY  technicienid DESC ";
