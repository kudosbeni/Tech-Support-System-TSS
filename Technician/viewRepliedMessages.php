           ...
           <!--                  <div class="pcoded-navigation-label">Manage Account</div>
                    ...
                    <div class="pcoded-content">
                        ...
                        <!-- Page-header end -->                    <div class="pcoded-inner-content">
                         ...
                         $query = $conn->query("SELECT * FROM `messagetb` WHERE technicieid = '".$_SESSION['technicienid']."'  ORDER BY  messageid DESC") or die(mysqli_error());
                                                                ...
                                                                <td><?php echo $sno; ?></td>
                                                                 <td><?php echo $fetch['customername']?></td>
                                                                  <td><?php echo $fetch['sentsms']?></td>
                                                                   <td style="color: blue;"  ><?php echo $fetch['receivedsms']?></td>
