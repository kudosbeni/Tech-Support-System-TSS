        ...
        <div class="pcoded-container navbar-wrapper">
           ...
           <!--                  <div class="pcoded-navigation-label">Manage Account</div>
                    ...
                    <div class="pcoded-content">
                        ...
                        <!-- Page-header end -->                    <div class="pcoded-inner-content">
                            <!-- Main-body start -->
                            <div class="main-body">
                         ...
                         $query = $conn->query("SELECT * FROM `messagetb` WHERE technicieid = '".$_SESSION['technicienid']."' AND receivedsms='not replied' ORDER BY  messageid DESC") or die(mysqli_error());
                                                            ...
                                                            <tr class="table-active">
                                                                ...
                                                                <td><?php echo $sno; ?></td>
                                                                 <td><?php echo $fetch['customername']?></td>
                                                                  <td><?php echo $fetch['sentsms']?></td>
                                                                   <td style="color: red;"  ><?php echo $fetch['receivedsms']?></td>
                                                                  
                                                                     <td><?php echo $fetch['sentontime']?></td>
                                                                       <td><?php echo $fetch['sentondate']?></td>
                                                                     
                                                                       
                                                            
                                                                <td>

                     <a title="Comment  Account"  href="replyMessages.php?id=<?php echo $fetch['messageid']?>"  class="  ">  <span class="fa fa-comments fw-fa"></span></a>
