<?php  
session_start();  
require ("addReplyMessageQuery.php");
                            ...
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span id="more-details"><?php echo $_SESSION["techniciennames"]; ?><i class="fa fa-caret-down"></i></span>
                                    </div>
                                </div>
                                        ...
                                        <li class=" ">
                                            <a href="homeTechinicien.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext"> <a href="technicianViewProfile.php">View Profile </a></span>
                                                <span class="pcoded-mcaret"></span>
                    ...
                    <div class="pcoded-content">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>All Not Replied Messages </h5>
                     ...
                     <p class="error eventaddedsuccess-error" style="color:green;background-color: #d2ffd2;">
                       ...
                       <?php echo $eventAddedSuccess;?>
                        ...
                        <p class="error repliedSmsTT-error" style="color:red;">
                                                  <!--    error message -->
                       <?php echo $repliedSms;?>
                       </p>
     <div class="container">
...
<ul class="p-0">
 ...
 $query = $conn->query("SELECT * FROM `messagetb` WHERE `messageid` ='$ID'") or die(mysqli_error());
...
<div class="col-md-9 col-sm-9 col-9 pr-0 comment-box">
    <form method="POST">
        <input type="hidden" class="form-control" name="messageId" value="<?php echo $fetch["messageid"]; ?>" required="" />
        <input type="hidden" class="form-control" name="custnames" value="<?php echo $fetch["customername"]; ?>" required="" />
        <input type="hidden" class="form-control" name="custid" value="<?php echo $fetch["customerid"]; ?>" required="" />
        <input type="hidden" class="form-control" name="technid" value="<?php echo $fetch["technicieid"]; ?>" required="" />
<input type="text" class="form-control" name="replyMess" placeholder="Message...." required="" />
</div>
