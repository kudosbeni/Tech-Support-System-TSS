<?php  
session_start();  
require ("updateCustomerProfileQuery.php");
...
<head>
   <title>Online Technician Support  MS</title>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="../assets/images/user.jpg" type="image/x-icon">
                ...
                <div class="pcoded-wrapper">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="homeCustomer.php"> <i class="fa fa-home"></i> </a>
                                            </li>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                     ...
                                     $query = $conn->query("SELECT * FROM `customertb` WHERE `customerid` ='".$_SESSION['customerid']."'") or die(mysqli_error());
                                     $fetch = $query->fetch_array();
                                      ?>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <h5 class="text-center h5 mb-0"><?php echo $fetch['customernames']?></h5>
                            ...
                            <div class="profile-info" style="margin-left: 20px;">
                                ...
                                <ul>
                                    <li>
                                     ...
                                     <?php echo $fetch['customeremail']?>
                                    </li>
                                    <li>
                                        <span>Phone Number:</span>
                                       <?php echo $fetch['customerphone']?>
                                    </li>
                                  <!--   <li>
                                        <span>Country:</span>
                                        America
                                    ...
                                    <li>
                                        <span>Address:</span>
                                        <?php echo $fetch['customeraddress']?><br>
                                                ...
                                                <form method="POST">
                                                    <ul class="profile-edit-list row">
                                                        <li class="weight-500 col-md-6">
                                                            ...
                                                            <input type="hidden" name="customeridd" value="<?php echo $fetch['customerid']?>"class="form-control" />
                                                            <div class="form-group">
                                                                <label>Full Name</label>
                                                                <input class="form-control form-control-lg"  name="custonames" type="text" value="<?php echo $fetch['customernames']?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Phone</label>
                                                                <input class="form-control form-control-lg" name="custophone" type="text" value="<?php echo $fetch['customerphone']?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input class="form-control form-control-lg" name="custoemail" type="email" value="<?php echo $fetch['customeremail']?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Addrress</label>
                                                                <input class="form-control form-control-lg date-picker" name="custoaddrress" type="text" value="<?php echo $fetch['customeraddress']?>">
                                                            </div>
                                                      ...
                                                      <!--       <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control form-control-lg" name="custopass" type="text" value="<?php echo $fetch['customerpassw']?>">
                                                            </div>
                                                           <!--  <div class="form-group">
