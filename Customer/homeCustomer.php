                         ...
                         ?>
                                                        ...
                                                        <tbody>
                                                            <tr class="table-active">
                                                                ...
                                                                <td><img src="../photo/<?php echo $fetch['technicienphoto']?>" alt=""  alt="user image" class="img-radius img-50 align-top m-r-15"></td>
                                                                <td><?php echo $fetch['addedon']?></td>
                                                                <td>
                                                                    
                                                                

                         <a title="Edit Account " href="technicienProfileDetails.php?id=<?php echo $fetch['technicienid']?>"  class="">  <span class="fa fa-eye fw-fa"></span></a>

                     <a title="Comment  Account"  href="chatToTechinician.php?id=<?php echo $fetch['technicienid']?>"  class="  ">  <span class="fa fa-comments fw-fa"></span></a>
