<?php
require ("signUpCustomerQuery.php");
                        ...
                        <div class="auth-box card">
                         ...
                         <!--        <div class="form-group form-primary">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="text" name="custonames" class="form-control" required="">
                                            <span class="form-bar"></span>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="text" name="custophone" maxlength="14" class="form-control">
                                            <span class="form-bar"></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="email" name="custoemail" class="form-control" required="">
                                            <span class="form-bar"></span>
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="password" name="custopass" class="form-control" required="">
                                            <span class="form-bar"></span>
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" name="custoaddrress" class="form-control" required="">
                                            <span class="form-bar"></span>
                          ...
                          <!--       <div class="row m-t-25 text-left">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="savecust" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Sign up now</button>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
