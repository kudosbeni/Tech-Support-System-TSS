        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-image">
             <img src="photo/<?php echo $fetch['technicienphoto']?>" alt="" height = "120" width = "600">
            </div>
          </div>
							...
							<div class="single-package-item">
								...
								<div class="single-package-item-txt">
									...
									<div class="packages-para">
										<h5>
												 Phone Number :<?php echo $fetch['technicienphone']?>
										...
										<h5>
										 ...
										 <h5>
											 ...
											 Address:  <?php echo $fetch['technicieaddress']?>
											
											
		</h5>
									</div><!--/.packages-para-->
									<div class="packages-review">
											<h5 class="mb-20 h5 text-blue">Speciality</h5>
										<h5>
											Special in: <?php echo $fetch['technicienspecial']?>
											
		</h5>
										  <h5><?php echo $fetch['techniciendescrip']?></h5>
