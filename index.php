						...
						<div class="col-sm-12">
							<div class="single-about-us">
								<div class="about-us-txt">
									<h2>Welcome To TSS <br><br>
										We Help People To Meet With Tech Specialist
									</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="left-content">
              ...
              <h4>We are Tech Support Specialist who are crucial in ensuring smooth operations, addressing concerns promptly, and maintaining customer satisfaction.  <br><br><br><br> We do provide technical assistance and resolve issues related to hardware, software, or any technology-related problems faced by users or customers.</h4>
			 <br> <div>
						<h3>
					Contact:
					</h3>
					<br>
					<h4>Email: <span>techsupportsystem@tss.com</span></h4><br>
					<h4>Tel: <spana>+250788804249</span></h4><br>
					<h4>Kimironko, Kigali/Rwanda KGL 3 St 100 AV</h4>
		             </div>
					...
					<!--/.col-->
						...
						<div class="col-md-4 col-sm-6">
							<div style="width:293px;">
								<img src="photo/<?php echo $fetch['technicienphoto']?>"  >
							</div>
							<div class="single-package-item">
								
								<div class="single-package-item-txt">
								<h3><?php echo $fetch['techniciennames']?>
										 <?php
											                                 if ($Status=="Online") {
